...
6.	Membuat Pull Request di GitHub
  	...
  	Buka repositori di GitHub, lalu klik tombol Compare & Pull Request. Isi bagian ‘Add a Title’, ‘Description’, dan ‘Reviewers’. Setelah semua terisi, klik tombol Create pull request.
